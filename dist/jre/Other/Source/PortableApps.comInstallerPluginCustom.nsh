...
!macro CustomCodePostInstall
	Rename "$INSTDIR\jre1.8.0_311\bin" "$INSTDIR\bin"
	Rename "$INSTDIR\jre1.8.0_311\legal" "$INSTDIR\legal"
	Rename "$INSTDIR\jre1.8.0_311\lib" "$INSTDIR\lib"
	Rename "$INSTDIR\jre1.8.0_311\COPYRIGHT" "$INSTDIR\COPYRIGHT"
	Rename "$INSTDIR\jre1.8.0_311\LICENSE" "$INSTDIR\LICENSE"
	Rename "$INSTDIR\jre1.8.0_311\README.txt" "$INSTDIR\README.txt"
	Rename "$INSTDIR\jre1.8.0_311\release" "$INSTDIR\release"
	Rename "$INSTDIR\jre1.8.0_311\THIRDPARTYLICENSEREADME.txt" "$INSTDIR\THIRDPARTYLICENSEREADME.txt"
	Rename "$INSTDIR\jre1.8.0_311\THIRDPARTYLICENSEREADME-JAVAFX.txt" "$INSTDIR\THIRDPARTYLICENSEREADME-JAVAFX.txt"
	Rename "$INSTDIR\jre1.8.0_311\Welcome.html" "$INSTDIR\Welcome.html"
	RMDir "$INSTDIR\jre1.8.0_311"
